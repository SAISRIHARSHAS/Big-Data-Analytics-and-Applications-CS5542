...
subfolders, each full of images for each label. The example folder climate_awareness
should have a structure like this:

~/climate_awareness/daisy/photo1.jpg
~/climate_awareness/daisy/photo2.jpg
...
~/climate_awareness/acid_rain/1.jpg
...
~/climate_awareness/sunflower/somepicture.jpg
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='data/climate_awareness',
